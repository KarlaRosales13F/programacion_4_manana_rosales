  ...
  Widget build(BuildContext context) {
    const pasos = [
      _PasoInfo(
        ...
        detalle: 'http.get() + FutureBuilder · Loyaltee API',
      ...
      _PasoInfo(
        ...
        detalle: 'TodoDto.fromJson · lista de canjes',
      ...
      _PasoInfo(
        ...
        titulo: 'Paso 2',
        subtitulo: 'DTO users',
        detalle: 'UsersDto.fromJson · lista de clientes',
        icono: Icons.data_object,
        color: Color.fromARGB(255, 103, 105, 221),
      ),
      _PasoInfo(
        ruta: '/paso3',
        titulo: 'Paso 3',
        subtitulo: 'API real + modelo de dominio',
        detalle: 'ProductoDto · toDomain() · API Loyaltee',
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Loyaltee — API REST'),
